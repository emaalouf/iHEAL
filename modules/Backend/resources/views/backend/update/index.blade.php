    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-success">
                ...
                <p>
                    <a href="https://github.com/juzaweb/iHealCMS/releases" target="_blank">{{ __('View change logs here') }}</a>. <a href="https://juzaweb.com/documentation/start/update" target="_blank">{{ __('View update guide here') }}</a>
                </p>
            </div>
